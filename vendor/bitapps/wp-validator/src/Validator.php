...
namespace BitApps\SMTP\Deps\BitApps\WPValidator;

use BitApps\SMTP\Deps\BitApps\WPValidator\Exception\MethodNotFoundException;
use BitApps\SMTP\Deps\BitApps\WPValidator\Exception\RuleErrorException;
